...
`extract` must not process `STRUCTURE.md`, `ARCHITECTURE.md`, `STACK.md`, or `CONCERNS.md` as monolithic files.
...
- runtime/library stack references → `section_ref` or tool-specific locator
