...
REPO_UNDERSTANDING_SECTIONS = artifact_validation.REPO_UNDERSTANDING_REQUIRED
KNOWLEDGE_CONFIDENCE_SECTIONS = artifact_validation.KNOWLEDGE_CONFIDENCE_REQUIRED
REPO_FACTS_SECTIONS = artifact_validation.REPO_FACTS_REQUIRED
DOMAIN_CANDIDATES_SECTIONS = artifact_validation.DOMAIN_CANDIDATES_SECTIONS
REVIEW_SUMMARY_SECTIONS = artifact_validation.REVIEW_SUMMARY_REQUIRED
